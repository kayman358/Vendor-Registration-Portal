...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Error - Internal Server</title>
...
%>
     <body>
        ...
        <div class="container">
            ...
            <center><h1><strong>A record that has similar attributes already exists!!!</strong></h1></center>
                  
         <center><h4>Please ensure you are not submitting a duplicate record to this server.</h4></center>
